...
class Estudiante
{
    ...
    public function GuardarEstudiante($ape,$nom,$dir,$tel)
    {
       ...
       $ComandoConexion->query("insert into estudiante (apellidos,nombre,direccion,telefono) values ("."'".$_POST['apellidos']."','".$_POST['nombre']."','".$_POST['direccion']."','".$_POST['telefono']."')" );
    ...
    public function ListarEstudiantes()
    {
      ...
      $resultado = $nuevoComando->query("Select * from estudiante");
      if(!$resultado)
      {
